...
const file_pubsub_pubsub_proto_rawDesc = "" +
	"\n" +
	"\x13pubsub/pubsub.proto\x12\x06pubsub\"@\n" +
	...
	"\x05topic\x18\x01 \x01(\tR\x05topic\"\x1d\n" +
	"\aMessage\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text2\x85\x01\n" +
	"\rPubsubService\x12:\n" +
	"\aPublish\x12\x16.pubsub.PublishRequest\x1a\x17.pubsub.PublishResponse\x128\n" +
	"\tSubscribe\x12\x18.pubsub.SubscribeRequest\x1a\x0f.pubsub.Message0\x01B:Z8github.com/nolannguyen1212/go-playground/proto/pb/pubsubb\x06proto3"
...
var file_pubsub_pubsub_proto_depIdxs = []int32{
	0, // 0: pubsub.PubsubService.Publish:input_type -> pubsub.PublishRequest
	2, // 1: pubsub.PubsubService.Subscribe:input_type -> pubsub.SubscribeRequest
	1, // 2: pubsub.PubsubService.Publish:output_type -> pubsub.PublishResponse
	3, // 3: pubsub.PubsubService.Subscribe:output_type -> pubsub.Message
